                    ...
                    <div class="account_form register">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h2 style="padding-top: 10px;"><i class="ion-android-search"></i> Find Your Account</h2>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form  action="{{route('customer-find')}}" method="post" onsubmit="return formValidation();">
                                    @csrf


                                    <p>
                                        <label style="font-weight: bold" for="phone "><i class="ion-android-call"></i> Enter Your Phone Number <span class="text-success">*</span></label>
                                        <input type="text" name="phone" id="phone" placeholder="Enter Phone Number with 11digit" style="font-weight: bolder;font-size: 16px;color:#40A944"   autocomplete="off">
                                        @error('phone')
                                    ...
                                    <div class="login_submit">
                                        <button type="submit" style="font-size: 16px;background: #40a944"><i class="ion-key"></i> Apply</button>
                                    </div>
                                </form>
                            </div>
                        </div>
