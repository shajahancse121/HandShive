                    ...
                    <div class="account_form register">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h2 style="padding-top: 10px;"><i class="ion-android-search"></i> Apply For New Password</h2>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form  action="{{route('apply-new-password')}}" method="post" onsubmit="return formValidation();">
                                    @csrf


                                    <p>
                                        <label style="font-weight: bold" for="code "><i class="ion-key"></i> Enter 4digit Code <span class="text-success">*</span></label>
                                        <input type="text" name="code" id="code" placeholder="Enter 4digit Code" style="font-weight: bolder;font-size: 20px;color:#40A944"    autocomplete="off">
                                        @error('code')
                                    ...
                                    <div class="login_submit">
                                        <div class="row">
                                            <div class="col-md-6"><a href="{{route('customer-resendcode-password')}}" style="color: #40A944;font-weight:400"> Resend Code? </a></div>
