            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <h3><i class="ion-ios-unlocked"></i> Email Verification</h3>
                        <ul>
                    ...
                    <div class="account_form register">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h2 style="padding-top: 10px;"><i class="ion-ios-keypad"></i> Email Verification</h2>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form  action="{{route('reemail-verify-save')}}" method="post" onsubmit="return formValidation();">
                                    @csrf


                                    <p>
                                        <label style="font-weight: bold" for="code"><i class="ion-key"></i> Enter Verification Code  <span class="text-success">*</span></label>
                                        <input type="text" name="code" id="code" placeholder="Enter 4digit code"  autocomplete="off">
                                        @error('code')
