            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <h3><i class="ion-ios-telephone"></i> Apply New Password</h3>
                        <ul>
                    ...
                    <div class="account_form register">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h2 style="padding-top: 10px;"><i class="ion-key"></i> Apply  New Password</h2>
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <form  action="{{route('password-reset-confirm')}}" method="post" onsubmit="return formValidation();">
                                    @csrf


                                    <p>
                                        <label style="font-weight: bold" for="password "><i class="ion-key"></i> Enter New Password <span class="text-success">*</span></label>
