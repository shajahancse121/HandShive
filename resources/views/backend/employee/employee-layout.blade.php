        ...
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{route('admin.dashboard')}}">
                    <img src="{{asset('frontend/icon.png')}}" class="navbar-logo" alt="logo">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{route('admin.dashboard')}}" class="nav-link"> {{$company->name}} </a>
            </li>
        </ul>
...
<div class="main-container" id="container">
    ...
    <div class="sidebar-wrapper sidebar-theme">
        ...
        @include('backend.employee.employee-sidebar')
    ...
    <div id="content" class="main-content">
        ...
        <div class="footer-wrapper">
            <div class="footer-section f-section-1" style="width: 100%;text-align: center">
                <p class="">Copyright © 2020 <a href="#" style="color: #0ba360;font-weight: bolder">{{$company->name}}</a> . All Rights Reserved.</p>
            </div>
