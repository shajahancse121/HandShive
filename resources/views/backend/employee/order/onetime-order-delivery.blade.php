                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-12">
                                                <h6 class=" inv-title"><i class="ion-checkmark-circled"></i>  Delivery Date :
                                                    <input type="date" style="padding: 5px 10px;font-weight: bold;color:#1b55e2!important" required name="delivery_date"  id="delivery_date" autocomplete="off" placeholder="Confirm Delivery Date">
                                                </h6>
                                                <hr>
                                            </div>
