        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="text" required name="name" class="form-control"  placeholder="Enter Blog Category Name">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                ...
                <div class="modal fade" id="exampleModal_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <form action="{{route('admin.edit-blog-category')}}" method="post">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="form-group row mb-4">
                                        <label for="hEmail" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Name</label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="text" required name="name" id="name" class="form-control"  placeholder="Enter Blog Category Name">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="hPassword" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Status</label>
...
@section('script')
    ...
    <script>
        ...
        function edit_category(category_id) {
            ...
            $.ajax({
                url: "{{ route('admin.edit-blog-category') }}",
                method: 'get',
                data: {
                ...
                success: function(result){
                    ...
                    $("#blog_category_id").val(category_id);
