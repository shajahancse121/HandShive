    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            ...
            <div class="widget-content widget-content-area br-6">
                <form class="select mt-4"  action="{{route('admin.edit-support-service',['id'=>$whychooseus->id])}}" method="post" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-xl-7 col-lg-7 col-sm-6">
                            <select name="department_id" required id="department_id"   class="selectpicker" data-live-search="true">
                                ...
                                @foreach($departments as $department)
                                    <option value="{{$department->id}}" {{$whychooseus->department_id==$department->id?'selected':''}}>{{$department->name}}</option>
                                @endforeach
                    ...
                    <div class="form-row">
                        ...
                        <div class="field_wrapper" style="width: 1000px">
                            @foreach(json_decode($whychooseus->support_tag) as $item)
                            <div style="margin-top: 10px;float: left" class="col-md-4"><input type="text" class="col-md-10 form-control"   name="support_tag[]" value="{{$item}}" placeholder="Enter  Tag" required style="display: inline-block !important;"/><a href="javascript:void(0);" class="remove_button col-md-1" style="padding-right: 0px;"><i class="far fa-trash-alt" style="font-size: 17px"></i></a></div>
                            @endforeach
                        </div>
                    ...
                    <div class="form-row" style="margin-top: 20px">
                        <div class="col-md-12 mb-4">
                            ...
                            <textarea class="textarea" name="support_message" style="height: 400px;" required placeholder="Enter Support & Services Description">{{$whychooseus->support_message}}</textarea>
                        ...
                        <div class="col-md-12">
                            <div id="select_menu" class="form-group mb-4">
                                ...
                                <select class="custom-select" name="status" required>
                                    <option value="">Choose...</option>
                                    <option value="1" {{$whychooseus->status==1?'selected':''}}>Published</option>
                                    <option value="0" {{$whychooseus->status==0?'selected':''}}>Unpublished</option>
