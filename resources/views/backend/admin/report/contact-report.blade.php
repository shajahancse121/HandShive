            ...
            <div class="widget-content widget-content-area br-6">
                <div class="row" style="margin-bottom: 10px">
                    <h4 style="margin-left: 20px;">
                        ...
                        <div class="icon-container" style="font-style: normal !important;">
                            <span class="ion-document-text"> Customer Contact Report</span>
                        </div>
                ...
                <div class="table-responsive mb-4 mt-4">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        @foreach($billings as $contact)

                            <?php
                             $contact = \App\Blling::where('mobile',$contact->mobile)->first();
                            ?>
                            <tr>
                                <td>{{$sl++}}</td>
                                <td>{{$contact->name}}</td>
                                <td>88{{$contact->mobile}}</td>
                                <td>{{$contact->email}}</td>
                        ...
                        @foreach($shipping as $contact)

                            <?php
                            $contact = \App\OtherShipping::where('mobile',$contact->mobile)->first();
                            ?>
                            <tr>
                                <td>{{$sl++}}</td>
                                <td>{{$contact->name}}</td>
