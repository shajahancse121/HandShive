                ...
                <div class="table-responsive mb-4 mt-4">
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        ...
                        @foreach($order_details as $details)
                            ...
                            $total_amount+=($details->qty*$details->sales_rate);
                            ...
                            else if($unit->name=='ltr')
                            {
                             ...
                             if($unit->id==1 || $unit->id==3)
                                 {
                                     $total_weight+=($details->weight/1000)*$details->qty;

                                 }else{

                                 $total_weight+=$details->weight*$details->qty;
                            }
                            ...
                            <tr>
                                <td>{{$sl++}}</td>
                                <td>{{date('d-m-Y',strtotime($details->order_date))}}</td>

                                <td>{{$product->name}}</td>
                                <td>{{$details->qty}}</td>
                                <td>{{$details->weight}} {{$unit->name}}</td>
                                <td>{{$details->sales_rate}}</td>
                                <td>{{$details->discount_amount}}</td>
                                <td>{{number_format($details->sales_rate*$details->qty)}}</td>
