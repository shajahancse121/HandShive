...
@section('title')
    Daily Sales Report|Bonaji Shop
    @endsection
@section('content')
                ...
                <div class="row" style="margin-bottom: 10px">
                    <h4 style="margin-left: 20px;">
                        ...
                        <div class="icon-container" style="font-style: normal !important;">
                            <span class="ion-document-text"> Daily Sale Report</span>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-9 offset-1">
                        <div class="card component-card_1" style="min-width: 100%">
                            <div class="card-body">
                                <form style="width: 100%" action="{{route('search.sale-report')}}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <input type="text" required class="form-control" name="start_date" value="{{$start_date}}" id="start_date" autocomplete="off" placeholder="Enter Start Date">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                <input type="text" required class="form-control" name="end_date" id="end_date" value="{{$end_date}}" autocomplete="off" placeholder="Enter End Date">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
