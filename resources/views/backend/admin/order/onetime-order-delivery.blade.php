                        ...
                        <div class="content-section  animated animatedFadeInUp fadeInUp">
                            ...
                            <div class="row inv--head-section">
                                ...
                                <div class="col-sm-6 col-12">
                                    <h3 class="in-heading"><i class="ion-ios-cart" style="font-size: 30px"></i> Delivery Order</h3>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-center" scope="col">Sale Rate</th>
                            ...
                            <form action="{{route('onetime-order-delivery-save',['order_id'=>$order->id])}}" method="post" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="inv--payment-info">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-5 col-12">
                                                <p class=" inv-subtitle" style="font-size: 15px;color: #0e1726"><i class="ion-card" style="font-size: 20px"></i> Payment By : </p>
                                            </div>
                                            <div class="col-sm-7 col-12">
                                                <p class="" style="font-size: 15px;color: #0e1726">{{$order->payment_type->name}} &nbsp;
                                                    </p>
                                            </div>
                                            ...
                                            <div class="col-sm-8 col-12">
                                                <p class="" style="font-size: 15px;color: #0e1726">{{isset($order->courier->name)?$order->courier->name:'No Courer Confirm'}}  &nbsp;&nbsp;</p>
                                            </div>
                                            <div class="col-sm-5 col-12">
                                                <p class=" inv-subtitle" style="font-size: 14px;color: #0e1726"><i class="ion-android-car" style="font-size: 20px"></i> Shipping Area : </p>
                                            </div>
                                            <div class="col-sm-7 col-12">
                                                <p class="" style="font-size: 15px;color: #0e1726">{{$order->shipping_title}} &nbsp;&nbsp;</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="inv--payment-info">
                                        <div class="row">
                                            <div class="col-sm-12 col-12">
                                                <h6 class=" inv-title"><i class="ion-checkmark-circled"></i>  Delivery Date :
                                                    <input type="text" style="padding: 5px 10px;font-weight: bold;color:#1b55e2!important" required name="delivery_date"  id="delivery_date" autocomplete="off" placeholder="Confirm Delivery Date">
                                                </h6>
                                                <hr>
                                            </div>
                                    ...
                                    <div class="inv--total-amounts text-sm-right">
                                        <div class="row">
                                            ...
                                            <div class="col-6 text-left">
                                                    ...
                                                    <button type="submit" style="width: 220px" class="btn btn-primary btn-rounded mb-2"><i class="ion-android-car" style="font-size: 18px;font-weight: bold"></i> Delivery Order</button>
